...
export declare const mat4MulMat4: (m1: Mat4, m2: Mat4) => Mat4;
...
export declare const mat4Ortho: (left: number, right: number, bottom: number, top: number, nearZ: number, farZ: number) => Mat4;
export declare const mat4Perspective: (fovy: number, aspect: number, nearZ: number, farZ: number) => Mat4;
