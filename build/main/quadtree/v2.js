...
exports.quadTreeFromLinesV2 = exports.QuadTreeV2 = exports.QuadTreeNode = void 0;
...
class QuadTreeNode {
    ...
    subdivide() {
        ...
        const toVec = ({ x, y }) => (0, vector_1.VEC2)(x, y);
...
exports.QuadTreeV2 = QuadTreeV2;
const quadTreeFromLinesV2 = (lines) => {
    const points = lines.flat();
    const bounds = (0, aabb_1.aabbUniform)((0, aabb_1.aabbFromPoints)(points));
    const quadLines = lines.map((line) => {
        return {
            line: line,
            bounds: (0, aabb_1.aabbUniform)((0, aabb_1.aabbFromPoints)(line))
        };
    });
...
exports.quadTreeFromLinesV2 = quadTreeFromLinesV2;
