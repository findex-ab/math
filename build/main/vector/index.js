...
class Vector {
    ...
    scale(s) {
        ...
        switch (count) {
            case 2:
                return (0, exports.VEC2)(this.x * s, this.y * s);
            case 3:
                return (0, exports.VEC3)(this.x * s, this.y * s, this.z * s);
            default:
    ...
    add(b) {
        ...
        switch (count) {
            case 2:
                return (0, exports.VEC2)(this.x + b.x, this.y + b.y);
            case 3:
                return (0, exports.VEC3)(this.x + b.x, this.y + b.y, this.z + b.z);
            default:
                throw new Error(`Vector has ${count} components`);
        }
    }
    ...
    run(f) {
        ...
        switch (count) {
            case 2:
                return (0, exports.VEC2)(f(this.x), f(this.y));
            case 3:
                return (0, exports.VEC3)(f(this.x), f(this.y), f(this.z));
            default:
                throw new Error(`Vector has ${count} components`);
        }
    }
    ...
    lerp(b, scale) {
        ...
        switch (count) {
            case 2:
                return (0, exports.VEC2)((0, etc_1.lerp)(this.x, b.x, scale), (0, etc_1.lerp)(this.y, b.y, scale));
            case 3:
                return (0, exports.VEC3)((0, etc_1.lerp)(this.x, b.x, scale), (0, etc_1.lerp)(this.y, b.y, scale), (0, etc_1.lerp)(this.z || 0, b.z || 0, scale));
            default:
                throw new Error(`Vector has ${count} components`);
        }
    }
