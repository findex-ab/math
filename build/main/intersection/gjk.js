...
const meshCenter = (mesh) => vector_1.Vector.avg(mesh.points);
class GJK {
    addSupport(dir) {
    ...
    tripleProduct(a, b, c) {
        const A = (0, vector_1.VEC3)(a.x, a.y, 0);
        const B = (0, vector_1.VEC3)(b.x, b.y, 0);
        const C = (0, vector_1.VEC3)(c.x, c.y, 0);
    ...
    evolveSimplex() {
        switch (this.vertices.length) {
            case 0:
                {
                    this.direction = meshCenter(this.shapeB.mesh).mulMat4((0, physics_1.physicsBodyGetMatrix)(this.shapeB)).sub(meshCenter(this.shapeA.mesh).mulMat4((0, physics_1.physicsBodyGetMatrix)(this.shapeA)));
    ...
    constructor(shapeA, shapeB) {
        this.vertices = [];
        this.direction = (0, vector_1.VEC3)(1, 1, 1);
        // reset everything
